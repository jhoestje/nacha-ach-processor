...
public class AchBatchHeaderRecord {
    ...
    @Nullable
    private String companyDiscretionaryData; // Not required; Originator/ODFI may include codes of significance only to them
    ...
    @Nullable
    private LocalDate settlementDate; // Not required; Date assigned by ACH Operator, left blank initially
